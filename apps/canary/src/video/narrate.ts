...
import { buildSrt, captionLineMax, stripOverrideTags } from "./srt.js";
import {
  type StyleId,
  selectStyle,
  selectThemes,
...
// Timeouts (ms). The LLM call is generous; `say` is bounded like condense's
// encode pass. (The ffmpeg probe/encode timeouts live in ffmpeg.ts.)
