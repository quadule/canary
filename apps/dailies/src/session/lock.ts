...
import { sessionDir } from "dailies-daemon-client";
...
// stale no matter how long its critical section runs — a `dailies run` can hold
...
// because concurrent `dailies run --session X` invocations are separate
