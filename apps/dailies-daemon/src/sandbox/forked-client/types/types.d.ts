...
export interface Page {
  ...
  waitForEvent(
    event: "close",
    optionsOrPredicate?:
      | { predicate?: (page: Page) => boolean | Promise<boolean>; timeout?: number }
  ...
  waitForEvent(
    event: "dialog",
    optionsOrPredicate?:
      | { predicate?: (dialog: Dialog) => boolean | Promise<boolean>; timeout?: number }
  ...
  waitForEvent(
    event: "download",
    optionsOrPredicate?:
      | { predicate?: (download: Download) => boolean | Promise<boolean>; timeout?: number }
  ...
  waitForEvent(
    event: "filechooser",
    optionsOrPredicate?:
      | { predicate?: (fileChooser: FileChooser) => boolean | Promise<boolean>; timeout?: number }
  ...
  waitForEvent(
    event: "frameattached",
    optionsOrPredicate?:
      | { predicate?: (frame: Frame) => boolean | Promise<boolean>; timeout?: number }
  ...
  waitForEvent(
    event: "pageerror",
    optionsOrPredicate?:
      | { predicate?: (error: Error) => boolean | Promise<boolean>; timeout?: number }
  ...
  waitForEvent(
    event: "request",
    optionsOrPredicate?:
      | { predicate?: (request: Request) => boolean | Promise<boolean>; timeout?: number }
  ...
  waitForEvent(
    event: "response",
    optionsOrPredicate?:
      | { predicate?: (response: Response) => boolean | Promise<boolean>; timeout?: number }
  ...
  waitForEvent(
    event: "websocket",
    optionsOrPredicate?:
      | { predicate?: (webSocket: WebSocket) => boolean | Promise<boolean>; timeout?: number }
  ...
  waitForEvent(
    event: "worker",
    optionsOrPredicate?:
      | { predicate?: (worker: Worker) => boolean | Promise<boolean>; timeout?: number }
 ...
 *   const page = await browser.newPage();
 *   await page.goto('https://www.google.com/chrome/browser/dailies.html');
...
export interface BrowserContext {
  ...
  waitForEvent(
    ...
    optionsOrPredicate?:
      | {
          predicate?: (browserContext: BrowserContext) => boolean | Promise<boolean>;
          timeout?: number;
        }
  ...
  waitForEvent(
    event: "weberror",
    optionsOrPredicate?:
      | { predicate?: (webError: WebError) => boolean | Promise<boolean>; timeout?: number }
...
export interface Locator {
   ...
   * @param options
   */
  evaluate<R, Arg, E extends SVGElement | HTMLElement = SVGElement | HTMLElement>(
    pageFunction: PageFunctionOn<E, Arg, R>,
    arg: Arg,
    options?: {
      timeout?: number;
   ...
   * @param options
   */
  evaluateHandle<R, Arg, E extends SVGElement | HTMLElement = SVGElement | HTMLElement>(
    pageFunction: PageFunctionOn<E, Arg, R>,
    arg: Arg
  ): Promise<SmartHandle<R>>;
  /**
   ...
   * @param options
   */
  evaluateHandle<R, E extends SVGElement | HTMLElement = SVGElement | HTMLElement>(
    pageFunction: PageFunctionOn<E, void, R>
  ): Promise<SmartHandle<R>>;
  /**
   ...
   */
  evaluateAll<R, Arg, E extends SVGElement | HTMLElement = SVGElement | HTMLElement>(
    pageFunction: PageFunctionOn<E[], Arg, R>,
    arg: Arg
  ): Promise<R>;
  /**
...
export interface BrowserType<Unused = {}> {
   ...
   * [Chrome Dailies](https://www.google.com/chrome/browser/dailies.html) or
  ...
  launchPersistentContext(
    ...
    options?: {
       ...
       *
       * Use "chrome", "chrome-beta", "chrome-dev", "chrome-dailies", "msedge", "msedge-beta", "msedge-dev", or
       * "msedge-dailies" to use branded [Google Chrome and Microsoft Edge](https://playwright.dev/docs/browsers#google-chrome--microsoft-edge).
       */
      channel?: string;
...
export interface CDPSession {
  on: <T extends keyof Protocol.Events | symbol>(
    event: T,
    listener: (
      payload: T extends symbol ? any : Protocol.Events[T extends keyof Protocol.Events ? T : never]
    ) => void
  ) => this;
...
export interface AndroidDevice {
  ...
  waitForEvent(
    ...
    optionsOrPredicate?:
      | {
          predicate?: (androidDevice: AndroidDevice) => boolean | Promise<boolean>;
          timeout?: number;
        }
      | ((androidDevice: AndroidDevice) => boolean | Promise<boolean>)
  ): Promise<AndroidDevice>;
  ...
  waitForEvent(
    ...
    optionsOrPredicate?:
      | {
          predicate?: (androidWebView: AndroidWebView) => boolean | Promise<boolean>;
          timeout?: number;
        }
...
export interface WebSocket {
  ...
  waitForEvent(
    event: "socketerror",
    optionsOrPredicate?:
      | { predicate?: (string: string) => boolean | Promise<boolean>; timeout?: number }
