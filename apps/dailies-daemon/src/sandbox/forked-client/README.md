...
This directory is a forked subset of Playwright's client-side code, adapted to run inside the QuickJS WASM sandbox used by dailies.
...
The fork lets dailies keep the Playwright object model and protocol semantics while replacing the runtime assumptions around it.
