...
import type { BrowserSummary } from "dailies-protocol";
import {
  type Browser,
  type BrowserContext,
  chromium,
...
export class BrowserManager {
  ...
  // null if the browser/page isn't there. Powers `dailies session url`, which
  ...
  async settleActivePage(
    ...
    //    fetch, ignoring Dailies's own overlay animations.
